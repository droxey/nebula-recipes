...
- `input_text`: the text to humanize (required)
- `tone`: desired tone — neutral, conversational, professional, cheeky (default: conversational)
- `show_changes`: list every change made (default: false)
